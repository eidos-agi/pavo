    ...
    *,
    ...
    payload = {
        ...
        "artifacts": {
            ...
            "review_bundle_markdown": str(proof_path.with_name("pavo-batch-review-bundle.md")),
            "review_bundle_json": str(proof_path.with_name("pavo-batch-review-bundle.json")),
...
<body>
  ...
  <main>
    ...
    <section class="card">
      <h2>Review bundle</h2>
      <p>The bundle is the fingerprinted audit record for this launch. It is generated by <code>pavo batch review-now</code>.</p>
      <p><code>{escape(str(artifacts.get('review_bundle_markdown') or ''))}</code></p>
    </section>
    <section class="card">
      <h2>Artifacts</h2>
