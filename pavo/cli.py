...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "batch":
        ...
        if args.batch_command == "prove":
            ...
            return 0 if result.passed else 2
        if args.batch_command == "handoff":
            try:
                handoff = load_operator_handoff(args.proof_report)
        ...
        if args.batch_command == "review-now":
            ...
            report = {
                ...
                "blockers": (
                    readiness.blockers
                    + review_bundle_result.blockers
                    + review_bundle_verification.blockers
            ...
            if (
                ...
                and review_bundle_result.passed
                and review_bundle_verification.passed
